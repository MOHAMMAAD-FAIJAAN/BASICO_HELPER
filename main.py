...
import os
token = '7044468247:AAF2yTtQuoCOJn3CgAzH10pyrtNpzos-3OE' #bottoken
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = '5539462061'
allowed_users = ['5539462061']  #Your ID
...
def add_user(message):
    if str(message.chat.id) == '5539462061':  # Only bot owner can add new users
        try:
